/**
  * $Header: /home/master/nWave-DM-Common/test/com/npower/cp/template/TestImpsTemplate.java,v 1.2 2007/10/09 02:09:31 LAH Exp $
  * $Revision: 1.2 $
 ...
 */
public class TestImpsTemplate extends BaseTestCase {
   ...
   * @return
   */
  private OMAClientProvSettings getImpsSettings() {
    ...
    ApplicationElement application = new ApplicationElement(AppID.WA_Wireless_Village_User_Agent);
    settings.addApplicationElement(application);
    application.addAddr("http://app.a.com");
    application.addAddr("https://app.a.com");
    application.setAppAccept("application/vnd.wv.csp+wbxml;1.2;1.1;1.0");
  ...
  public void testMergeOMACP() throws Exception {
    ...
    ClientProvTemplate template = inventory.findTemplate(null, null, ProfileCategory.IMPSP_CATEGORY_NAME);
    assertNotNull(template);
    
    OMAClientProvSettings settings = getImpsSettings();
    ...
    "    <parm name=\"AACCEPT\" value=\"application/vnd.wv.csp+wbxml;1.2;1.1;1.0\"/> "+ 
    "    <parm name=\"ADDR\" value=\"http://app.a.com\"/>  "+
    "    <parm name=\"ADDR\" value=\"https://app.a.com\"/> "+ 
  ...
  public void testMergeNokia() throws Exception {
    ...
    ClientProvTemplate template = inventory.findTemplate("nokia", "6681", ProfileCategory.IMPSP_CATEGORY_NAME);
    assertNotNull(template);
  ...
  public void testMergeSonyEricssonW800() throws Exception {
    ...
    ClientProvTemplate template = inventory.findTemplate("SonyEricsson", "W800", ProfileCategory.IMPSP_CATEGORY_NAME);
    assertNotNull(template);
  ...
  public void testMergeSonyEricsson810() throws Exception {
    ...
    ClientProvTemplate template = inventory.findTemplate("SonyEricsson", "W810", ProfileCategory.IMPSP_CATEGORY_NAME);
    assertNotNull(template);
