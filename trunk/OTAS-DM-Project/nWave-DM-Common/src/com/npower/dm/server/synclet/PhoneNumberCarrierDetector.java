/**
  * $Header: /home/master/nWave-DM-Common/src/com/npower/dm/server/synclet/PhoneNumberCarrierDetector.java,v 1.2 2008/06/16 10:11:15 zhao Exp $
  * $Revision: 1.2 $
 ...
 */
public class PhoneNumberCarrierDetector implements Serializable, CarrierDetector {

  protected static Log log = LogFactory.getLog(PhoneNumberCarrierDetector.class);
  
  /**
   * 
   */
  public PhoneNumberCarrierDetector() {
    super();
  }
  ...
  public String getCarrierID(String deviceExternalID, String phoneNumber, HttpServletRequest httpRequest, SyncML message) throws DMException {
    ...
    try {
        ...
        Carrier carrier = carrierBean.findCarrierByPhoneNumberPolicy(phoneNumber);
        if (carrier != null) {
