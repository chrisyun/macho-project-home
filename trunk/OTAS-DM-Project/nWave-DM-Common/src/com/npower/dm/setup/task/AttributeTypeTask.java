/**
  * $Header: /home/master/nWave-DM-Common/src/com/npower/dm/setup/task/AttributeTypeTask.java,v 1.1 2008/09/05 03:24:40 zhao Exp $
  * $Revision: 1.1 $
 ...
 */
public class AttributeTypeTask extends DMTask {

  /**
   * Default constructor
   */
  public AttributeTypeTask() {
    super();
  }
  ...
  protected void process() throws SetupException {
    ...
    try {
        ...
        for (String filename: filenames) {
            ...
            profileBean.importProfileAttributeType(new FileInputStream(file));
        }
    } catch (Exception ex) {
      if (factory != null) {
         factory.rollback();
      }
      throw new SetupException("Error in import Profile Attribute Types.", ex);
    } finally {
      if (factory != null) {
         factory.release();
      }
