/**
  * $Header: /home/master/nWave-DM-Common/src/com/npower/dm/setup/task/ProfileCategoryTask.java,v 1.1 2008/09/05 03:24:40 zhao Exp $
  * $Revision: 1.1 $
 ...
 */
public class ProfileCategoryTask extends DMTask {

  /**
   * Default constructor
   */
  public ProfileCategoryTask() {
    super();
  }
  ...
  protected void process() throws SetupException {
    ...
    try {
        ...
        for (String filename: filenames) {
            ...
            profileBean.importCategory(new FileInputStream(file));
        }
    } catch (Exception ex) {
      if (factory != null) {
         factory.rollback();
      }
      throw new SetupException("Error in import Profile categories.", ex);
    } finally {
      if (factory != null) {
         factory.release();
      }
