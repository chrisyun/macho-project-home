/**
 * $Header: /home/master/nWave-DM-Common/src/com/npower/dm/tracking/DMSessionLogger.java,v 1.1 2008/08/04 02:33:23 zhao Exp $
 * $Revision: 1.1 $
 ...
 */
public interface DMSessionLogger {
  /**
   * @param writer
   */
   ...
   * @throws IOException 
   */
  public abstract void log(String dmSessionId, HttpServletRequest request, int sizeOfRequestData, int sizeOfResponseData) throws IOException;
