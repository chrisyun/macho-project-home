/**
  * $Header: /home/master/nWave-DM-Common/src/com/npower/dm/hibernate/management/digester/ProfileTemplateEntityFactory.java,v 1.1 2006/11/08 02:16:53 zhao Exp $
  * $Revision: 1.1 $
 ...
 */
public class ProfileTemplateEntityFactory implements ObjectCreationFactory {

  private Digester digester = null;
  /**
   * 
   */
  public ProfileTemplateEntityFactory() {
    super();
  }
  ...
  public Object createObject(Attributes attrs) throws Exception {
    ...
    ProfileTemplate result = bean.newTemplateInstance();
    if (result instanceof ProfileTemplateEntity) {
       ((ProfileTemplateEntity)result).setManagementBeanFactory(this.getFactory());
    }
    return result;
  }
