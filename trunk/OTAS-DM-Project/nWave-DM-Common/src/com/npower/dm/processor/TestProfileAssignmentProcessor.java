/**
  * $Header: /home/master/nWave-DM-Common/src/com/npower/dm/processor/TestProfileAssignmentProcessor.java,v 1.28 2008/08/04 07:13:34 zhao Exp $
  * $Revision: 1.28 $
...
/**
 * @author Zhao DongLu
 * @version $Revision: 1.28 $ $Date: 2008/08/04 07:13:34 $
 */
public class TestProfileAssignmentProcessor extends TestCase {
  ...
  private void emulate(DMClientEmulator emulator, long jobID) throws IOException, Exception {
    ...
    String processorName = "ProfileAssignmentProcessor";
    BaseProcessor processor = new ProfileAssignmentProcessor();
  ...
  public static void main(String[] args) {
    junit.textui.TestRunner.run(TestSmartProfileAssignmentProcessor.class);
  }
