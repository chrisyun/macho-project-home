/**
  * $Header: /home/master/nWave-DM-Common/src/com/npower/dm/msm/SonyEricssonDMV3DiscoveryProcessor.java,v 1.1 2008/11/06 08:02:10 zhao Exp $
  * $Revision: 1.1 $
  * $Date: 2008/11/06 08:02:10 $
  *
  * ===============================================================================================
  * License, Version 1.1
  *
 ...
 * 
 * @author Zhao DongLu
 * @version $Revision: 1.1 $ $Date: 2008/11/06 08:02:10 $
 */
public class SonyEricssonDMV3DiscoveryProcessor extends BaseProcessor implements ManagementProcessor, Serializable {

  private static transient Log log = LogFactory.getLog(SonyEricssonDMV3DiscoveryProcessor.class);
   ...
   * 
   */
  public SonyEricssonDMV3DiscoveryProcessor() {
    super();
  }
  ...
  protected void readObject(java.io.ObjectInputStream in) throws java.io.IOException, ClassNotFoundException {
    super.readObject(in);
    log = LogFactory.getLog(SonyEricssonDMV3DiscoveryProcessor.class);
  }  
