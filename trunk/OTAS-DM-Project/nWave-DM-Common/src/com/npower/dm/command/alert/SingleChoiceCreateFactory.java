/**
  * $Header: /home/master/nWave-DM-Common/src/com/npower/dm/command/alert/SingleChoiceCreateFactory.java,v 1.1 2007/03/29 08:16:33 zhao Exp $
  * $Revision: 1.1 $
 ...
 */
public class SingleChoiceCreateFactory implements ObjectCreationFactory {

  private Digester digester = null;
  /**
   * 
   */
  public SingleChoiceCreateFactory() {
    super();
  }
  ...
  public Object createObject(Attributes attributes) throws Exception {
    ...
    object.setAlertCode(AlertCode.SINGLE_CHOICE);
