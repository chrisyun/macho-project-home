/**
  * $Header: /home/master/nWave-DM-Common/src/com/npower/dm/command/alert/DisplayCreateFactory.java,v 1.1 2007/03/29 08:16:33 zhao Exp $
  * $Revision: 1.1 $
 ...
 */
public class DisplayCreateFactory implements ObjectCreationFactory {

  private Digester digester = null;
  /**
   * 
   */
  public DisplayCreateFactory() {
    super();
  }
  ...
  public Object createObject(Attributes attributes) throws Exception {
    ...
    object.setAlertCode(AlertCode.DISPLAY);
