/**
  * $Header: /home/master/nWave-DM-Common/src/com/npower/dm/audit/hibernate/ProfileAuditLoggerDAO.java,v 1.1 2007/02/08 10:49:06 zhao Exp $
  * $Revision: 1.1 $
 ...
 */
public class ProfileAuditLoggerDAO extends BaseAuditLogger implements ProfileAuditLogger {

  /**
   * Default constructor.
   */
  public ProfileAuditLoggerDAO() {
    super();
  }
  
  /* (non-Javadoc)
   * @see com.npower.dm.audit.ProfileAuditLogger#log(com.npower.dm.audit.action.ProfileAction, java.lang.String, java.lang.String, long, java.lang.String, java.lang.String)
   */
  public long log(ProfileAction action, String username, String ipAddress, long profileID, String profileName, String description) throws AuditException {
    if (!this.isEnable()) {
       return 0;
    }
    if (action == null) {
    ...
    if (profileID == 0) {
       throw new AuditException("Must specified profileID.");
    }
