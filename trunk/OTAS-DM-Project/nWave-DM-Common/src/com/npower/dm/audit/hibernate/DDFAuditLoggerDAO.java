/**
  * $Header: /home/master/nWave-DM-Common/src/com/npower/dm/audit/hibernate/DDFAuditLoggerDAO.java,v 1.1 2007/02/08 10:49:06 zhao Exp $
  * $Revision: 1.1 $
 ...
 */
public class DDFAuditLoggerDAO extends BaseAuditLogger implements DDFAuditLogger {

  /**
   * Default constructor.
   */
  public DDFAuditLoggerDAO() {
    super();
  }
  
  /* (non-Javadoc)
   * @see com.npower.dm.audit.DDFAuditLogger#log(com.npower.dm.audit.action.DDFAction, java.lang.String, java.lang.String, long, java.lang.String, java.lang.String)
   */
  public long log(DDFAction action, String username, String ipAddress, long modelID, String modelExtID, String description) throws AuditException {
    if (!this.isEnable()) {
       return 0;
    }
    if (action == null) {
