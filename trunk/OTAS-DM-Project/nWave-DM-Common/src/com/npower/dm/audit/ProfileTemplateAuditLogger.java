/**
  * $Header: /home/master/nWave-DM-Common/src/com/npower/dm/audit/ProfileTemplateAuditLogger.java,v 1.1 2007/02/08 10:49:06 zhao Exp $
  * $Revision: 1.1 $
...
/**
 * Logger for profile template audit.
 * @author Zhao DongLu
 * @version $Revision: 1.1 $ $Date: 2007/02/08 10:49:06 $
 */
public interface ProfileTemplateAuditLogger extends AuditLogger {
   ...
   */
  public abstract long log(ProfileTemplateAction action, 
      String username, 
      String ipAddress,
      long templateID,
      String templateName,
