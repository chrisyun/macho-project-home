/**
  * $Header: /home/master/nWave-DM-Common/src/com/npower/dm/audit/hibernate/ProfileTemplateAuditLoggerDAO.java,v 1.2 2009/02/19 10:30:46 zhaowx Exp $
  * $Revision: 1.2 $
...
/**
 * @author Zhao DongLu
 * @version $Revision: 1.2 $ $Date: 2009/02/19 10:30:46 $
 */
public class ProfileTemplateAuditLoggerDAO extends BaseAuditLogger implements ProfileTemplateAuditLogger {

  /**
   * Default constructor.
   */
  public ProfileTemplateAuditLoggerDAO() {
    super();
  }
  
  /* (non-Javadoc)
   * @see com.npower.dm.audit.ProfileTemplateAuditLogger#log(com.npower.dm.audit.action.ProfileTemplateAction, java.lang.String, java.lang.String, long, java.lang.String, java.lang.String)
   */
  public long log(ProfileTemplateAction action, String username, String ipAddress, long templateID, String templateName, String description) throws AuditException {
    if (!this.isEnable()) {
       return 0;
    }
    if (action == null) {
    ...
    target.setProfileTemplateName(templateName);
