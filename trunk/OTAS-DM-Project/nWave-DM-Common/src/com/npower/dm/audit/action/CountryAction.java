/**
  * $Header: /home/master/nWave-DM-Common/src/com/npower/dm/audit/action/CountryAction.java,v 1.1 2007/02/07 08:42:09 zhao Exp $
  * $Revision: 1.1 $
...
public enum CountryAction {
   ...
   *        Value of action
   */
  private CountryAction(String value) {
    this.value = value;
  }
