/**
  * $Header: /home/master/nWave-DM-Common/src/com/npower/dm/audit/DDFAuditLogger.java,v 1.1 2007/02/08 10:49:06 zhao Exp $
  * $Revision: 1.1 $
...
/**
 * Logger for model DDF audit.
 * @author Zhao DongLu
 * @version $Revision: 1.1 $ $Date: 2007/02/08 10:49:06 $
 */
public interface DDFAuditLogger extends AuditLogger {
   ...
   */
  public abstract long log(DDFAction action, 
      String username, 
      String ipAddress,
      long modelID, 
      String modelExtID,
