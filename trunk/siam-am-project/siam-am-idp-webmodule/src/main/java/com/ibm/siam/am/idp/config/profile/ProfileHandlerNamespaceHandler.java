...
package com.ibm.siam.am.idp.config.profile;

import javax.xml.namespace.QName;

import com.ibm.siam.am.idp.config.profile.authn.UsernamePasswordLoginHandlerBeanDefinitionParser;
...
import edu.internet2.middleware.shibboleth.idp.config.profile.IdPProfileHandlerManagerBeanDefinitionParser;
import edu.internet2.middleware.shibboleth.idp.config.profile.ProfileHandlerGroupBeanDefinitionParser;
import edu.internet2.middleware.shibboleth.idp.config.profile.SAMLMetadataHandlerBeanDefinitionParser;
import edu.internet2.middleware.shibboleth.idp.config.profile.StatusHandlerBeanDefinitionParser;
