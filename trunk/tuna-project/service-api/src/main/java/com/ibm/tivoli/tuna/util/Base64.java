...
public class Base64 {
   ...
   * @since 1.3
   */
  private static void encode3to4(byte[] source, int srcOffset, int numSigBytes, Writer writer, int options) throws IOException {
    ...
    switch (numSigBytes) {
    case 3:
      writer.append((char)ALPHABET[(inBuff >>> 18)]);
      writer.append((char)ALPHABET[(inBuff >>> 12) & 0x3f]);
      writer.append((char)ALPHABET[(inBuff >>> 6) & 0x3f]);
      writer.append((char)ALPHABET[(inBuff) & 0x3f]);
      return;
    ...
    case 2:
      ...
      writer.append((char)ALPHABET[(inBuff >>> 12) & 0x3f]);
      writer.append((char)ALPHABET[(inBuff >>> 6) & 0x3f]);
      writer.append((char)EQUALS_SIGN);
      return ;
   ...
   * @since 2.3.1
   */
  public static void encodeBytesToWriter(byte[] source, Writer writer) {
    try {
      encodeBytesToWriter(source, 0, source.length, Base64.NO_OPTIONS, writer);
    } catch (IOException ex) {
      assert false : "IOExceptions only come from GZipping, which is turned off: " + ex.getMessage();
    }
  }
   ...
   * @since 2.3.1
   */
  public static void encodeBytesToWriter(byte[] source, int off, int len, int options, Writer writer) throws java.io.IOException {
    ...
    int lineLength = 0;
    for (; d < len2; d += 3, e += 4) {
      encode3to4(source, d + off, 3, writer, options);

      lineLength += 4;
      if (breakLines && lineLength == MAX_LINE_LENGTH) {
        writer.append((char)NEW_LINE);
        e++;
        lineLength = 0;
      } // end if: end of line
    } // en dfor: each piece of array
    ...
    if (d < len) {
      encode3to4(source, d + off, len - d, writer, options);
      e += 4;
    } // end if: some padding needed
  } // end encodeBytesToWriter
  ...
  public static byte[] decode(byte[] source, int off, int len, int options) throws RuntimeException {
    ...
    for (i = off; i < off + len; i++) { // Loop through source
      ...
      if (sbiDecode >= WHITE_SPACE_ENC) {
        ...
        throw new RuntimeException(String.format("Bad Base64 input character '%c' in array position %d", source[i], i));
      } // end else:
  ...
  public static void main(String[] args) throws Exception {
    String b64Encoded = "MS4gaW5jbHVkZdPvvuQgDQogICBjOiAgIGluY2x1ZGUgInN0ZGlvLmgiDQogICBj"
        + "Kys6IGluY2x1ZGUgPHN0ZGlvPg0KDQoyLmNvbnN0DQogICBj1tC1xGNvbnN0sbvI"
        + "z86qysfSu7/psrvE3LjEseS1xLTmtKLH+NPyo6zL+dLUY9bQo7oNCiAgICAgY29u"
        + "c3QgaW50IGJ1ZmZlcnNpemUgPSAxMDA7DQogICAgIGNoYXIgYnVmW2J1ZmZlcnNp"
        + "emVdOw0KICAg1eLKx7K7us+3qLXEo6zU2rHg0uvG2rzk08nT2mJ1ZmZlcnNpemXV"
        + "vNPD0ru/6bTmtKKjrMv50tSx4NLrxvcNCiAgILK71qq1wMv8tcTWtaOsyrnTwyNk"
        + "ZWZpbmUNCiAgIGMrK9bQxKzIz7K7uPhjb25zdLfWxeS05rSio6zH0srHxNqyv8Gs"
        + "vdOjrGPW0MSsyM/N4rK/way906OsYysr08MNCiAgIGV4dGVybse/1sa4xLHkzqrN"
        + "4rK/way90w0KMy5uZXcgZGVsZXRlDQo0LrHkwb/J+cP3tcTOu9bDICAgDQoNCiAg"
        + "ICBD1tCjrLHkwb/J+cP3us20+sLryse31r+qtcSjrLHY0OvU2rqvyv2/qsq8tKbJ"
        + "+cP3oaNDKyvW0KOsseTBv7/J0tTU2sjO0uK0psn5w/eju8D9yOejumZvcihpbnQg"
        + "aT0wO2k8MTA7aSsrKdTaQysr1tC/ydLUo6y1q9TaQ9bQseTBv2nSqtTazeLD5rao"
        + "0uWhow0KDQo1LnN0cnVjdL3hubnM5be9w+YNCg0KICAg08NzdHJ1Y3S2qNLlseTB"
        + "vyAgDQoNCnN0cnVjdCBteXN0cnVjdCAgIA0KDQp7ICAgICBpbnQgaTsgICAgIA0K"
        + "DQogICAgICBmbG9hdCB4OyAgDQoNCn0gICDU2mPW0Mn5w/dzdHJ1Y3Sx5MG/0qrV"
        + "4sO00LSjunN0cnVjdCBteXN0cnVjdCBhOyAgINTaQysr1tDHsMPmsrvTw7zTc3Ry"
        + "dWN0o7pteXN0cnVjdCBhOyAgDQoNCtK71ta85sjdtcTTw7eoysejuiANCg0KdHlw"
        + "ZWRlZiBzdHJ1Y3QgX215c3RydWN0DQoNCnsgICAgIGludCBpOw0KDQogICAgICBm"
        + "bG9hdCB4OyANCg0KfSBteXN0cnVjdDsgICDIu7rz08NteXN0cnVjdCC2qNLlseTB"
        + "vw0KDQo2LtTaQysr1tCjrHN0cnVjdL3hubnM5dans9azydSxuq/K/bXEtqjS5aOs"
        + "Q9bQsrvQ0MHtzeKjrEMrK9bQs8nUsbqvyv21xMSsyM+3w87Ky7XD97f7zqpwdWJs"
        + "aWMs1eLSu7Xjus3A4LK7zayjrMDgtcTErMjPt8POysu1w/e3+86qcHJpdmF0ZS4g"
        + "yP2hokMrK9bQ09Bib29sICi78mJvb2xlYW7A4NDNo6mju0PW0L/Jw7vT0NXi0fm1"
        + "xGJvb2zA4NDNo6y++c6qyv3WtcDg0M2joSAgDQoNCjcuYysr1tDT0NL908PA4NDN"
        + "o6xj1tDWu9PQ1rjV6w0KOC5jb3V0IHByaW50Zg0KOS5j1tC199PDuq/K/cewv8nS"
        + "1LK7ysLPyMn5w/ejrLHg0uvG97vhzai5/dXiuPa199PDssKy4rqvyv21xLao0uUs"
        + "yOejug0KICAgtffTwyB2b2lkIGZ1bihpbnQpOyC1q8q1vMrKx3ZvaWQgZnVuKGZs"
        + "b2F0KSy74bL6yfpidWcNCiAgYysr1tCx2NDrz8jJ+cP3uvO199PDDQoxMC7Uy8vj"
        + "t/u1xNbY1NgNCg0KDQpsaXpleHBlcnRpc2VuZXcgbWljcm9zb2Z0DQpsaXpleHBl"
        + "cnRpc2Vfa291YmVpQHNvaHUuY29tIG1pY2t5Lm5ldA0KNTg2ODIwNzUNCjE1MDAx" + "MDg4NTEyDQo1ODY4MzM1Mw0KY2dkYy5jb20uY24NCg0K";

    byte[] result = decode(b64Encoded);

    java.io.OutputStream out = new FileOutputStream(new File("/tmp/abc.bin"));
    out.write(result);
    out.close();
  }
