package com.ibm.tivoli.tuna.jaas.ldap.util;
...
public class LocalObjToObjectContextMapper implements ContextMapper {
	private static Log log = LogFactory.getLog(LocalObjToObjectContextMapper.class);
	 ...
	 * @param appClass
	 */
	public LocalObjToObjectContextMapper(String[] arrShowField) {
		super();
