 ...
 * 
 */
public class SpringLoginContext extends LoginContext implements ApplicationContextAware {
   ...
   */
  public SpringLoginContext(String name) throws LoginException {
    super(name);
    init(name);
   ...
   *              AuthPermission("createLoginContext.other")
   */
  public SpringLoginContext(String name, Subject subject) throws LoginException {
    super(name, subject);
    init(name);
    if (subject == null)
   ...
   *              AuthPermission("createLoginContext.other")
   */
  public SpringLoginContext(String name, CallbackHandler callbackHandler) throws LoginException {
   ...
   *              AuthPermission("createLoginContext.other")
   */
  public SpringLoginContext(String name, Subject subject, CallbackHandler callbackHandler) throws LoginException {
    this(name, subject);
    if (callbackHandler == null)
      throw new LoginException(ResourcesMgr.getString("invalid null CallbackHandler provided"));
    this.callbackHandler = new SecureCallbackHandler(java.security.AccessController.getContext(), callbackHandler);
   ...
   * @since 1.5
   */
  public SpringLoginContext(String name, Subject subject, CallbackHandler callbackHandler, Configuration config) throws LoginException {
  ...
  private void invoke(String methodName) throws LoginException {
    ...
    for (int i = moduleIndex; i < moduleStack.length; i++, moduleIndex++) {
      try {
        ...
        MessageFormat form = new MessageFormat(ResourcesMgr.getString("unable to instantiate LoginModule, module, because "
