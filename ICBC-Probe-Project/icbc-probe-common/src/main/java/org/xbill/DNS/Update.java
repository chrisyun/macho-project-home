...
public class Update extends Message {
  ...
  /**
   * Inserts a prerequisite that the specified name exists; that is, there exist
   * records with the given name in the zone.
   */
  ...
  /**
   * Parses a record from the string, and inserts a prerequisite that the record
   * exists. Due to the way value-dependent prequisites work, the condition that
   ...
   * the set of all records with the same and type in the update message must be
   * identical to the set of all records with that name and type on the server.
   */
