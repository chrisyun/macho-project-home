...
public class Generator {
  ...
  /**
   * Creates a specification for generating records, as a $GENERATE statement in
   * a master file.
   * 
   * @param start
   *          The start of the range.
   ...
   *          The pattern to use for generating record names.
   * @param type
   *          The type of the generated records. The supported types are PTR,
   *          CNAME, DNAME, A, AAAA, and NS.
   * @param dclass
   *          The class of the generated records.
   * @param ttl
   *          The ttl of the generated records.
   ...
   * 
   * @throws IOException
   *           The name or rdata was invalid after substitutions were performed.
   */
