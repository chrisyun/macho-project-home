...
public final class TTL {
   ...
   * @param clamp
   *          Whether to clamp values in the range [MAX_VALUE + 1, 2^32 -1] to
   *          MAX_VALUE. This should be donw for TTLs, but not other values
   *          which can be expressed in this format.
