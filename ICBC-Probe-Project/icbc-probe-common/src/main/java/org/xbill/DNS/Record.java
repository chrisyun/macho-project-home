...
public abstract class Record implements Cloneable, Comparable, Serializable {
   ...
   * @param data
   *          The rdata of the record, in uncompressed DNS wire format. Only the
   *          first length bytes are used.
   */
   ...
   *          The record's time to live.
   * @param data
   *          The complete rdata of the record, in uncompressed DNS wire format.
   */
