...
public interface Resolver {
   ...
   * 
   * @param level
   *          The EDNS level to use. 0 indicates EDNS0 and -1 indicates no EDNS.
   ...
   *          The EDNS level to use. 0 indicates EDNS0 and -1 indicates no EDNS.
   * @param payloadSize
   *          The maximum DNS packet size that this host is capable of receiving
   *          over UDP. If 0 is specified, the default (1280) is used.
   * @param flags
