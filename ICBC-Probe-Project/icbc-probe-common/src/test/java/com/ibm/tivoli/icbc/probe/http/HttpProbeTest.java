...
public class HttpProbeTest extends TestCase {
  ...
  public void testCase1() throws Exception {
    HttpProbe probe = new HttpProbeImpl(new String[] { "http://www.icbc.com.cn/icbc/html/guanggao/yuntongka/images/card_mdyt_04.gif" });
    HttpResult result = probe.run();
  ...
  public void testCase2() throws Exception {
    HttpProbe probe = new HttpProbeImpl(new String[] { "https://member.icbc.com.cn/icbc/html/main/images/wydl.gif" });
    HttpResult result = probe.run();
    StringWriter out = new StringWriter();
    result.toXML(out);
    System.out.println(out.toString());
  ...
  public void testCase3() throws Exception {
    HttpProbe probe = new HttpProbeImpl(new String[] { "http://www.abchina.com" });
    HttpResult result = probe.run();
    StringWriter out = new StringWriter();
    result.toXML(out);
    System.out.println(out.toString());
  ...
  public void testCase4() throws Exception {
    HttpProbe probe = new HttpProbeImpl(new String[] { "http://www.abchina.com/cn/" });
    HttpResult result = probe.run();
    StringWriter out = new StringWriter();
    result.toXML(out);
    System.out.println(out.toString());
  ...
  public void testCase5() throws Exception {
    HttpProbe probe = new HttpProbeImpl(new String[] { "http://www.abchina.com/cn/AboutABC/NewsCenter/201006/W020091201317868972715.jpg" });
    HttpResult result = probe.run();
    StringWriter out = new StringWriter();
    result.toXML(out);
    System.out.println(out.toString());
  ...
  public void testCase6() throws Exception {
    HttpProbe probe = new HttpProbeImpl(new String[] { "https://211.95.81.1/icbc/html/main/images/wydl.gif" });
    HttpResult result = probe.run();
    StringWriter out = new StringWriter();
    result.toXML(out);
    System.out.println(out.toString());
  ...
  public void testCase7() throws Exception {
    HttpProbe probe = new HttpProbeImpl(new String[] { "http://www.icbc-ltd.com/do_not_delete/noc_cdn.gif" });
    HttpResult result = probe.run();
  ...
  public void testCase8() throws Exception {
    HttpProbe probe = new HttpProbeImpl(new String[] { "https://corporbank.icbc.com.cn/icbc/images/webbank.gif" });
    HttpResult result = probe.run();
  ...
  /**
   */
  public void testCaseHttps() throws Exception {
    HttpProbe probe = new HttpProbeImpl(new String[] { "http://www.icbc.com.cn/do_not_delete/noc111.gif" });
    Date timestamp = new Date();
