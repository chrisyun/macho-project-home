...
public final class Extension {
  ...
  /**
   * The URL from which the most recent version of this optional package can be
   * obtained if it is not already installed.
   */
  ...
  /**
   * The version number (dotted decimal notation) for this implementation of the
   * optional package.
   */
  ...
  /**
   * The version number (dotted decimal notation) of the specification to which
   * this optional package conforms.
   */
  ...
  /**
   * If the specified manifest attributes entry represents an available optional
   * package, construct and return an <code>Extension</code> instance
