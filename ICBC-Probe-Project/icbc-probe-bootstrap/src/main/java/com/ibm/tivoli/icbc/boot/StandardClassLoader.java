...
public class StandardClassLoader extends URLClassLoader implements Reloader {
  ...
  /**
   * Construct a new ClassLoader with no defined repositories and the specified
   * parent ClassLoader.
   * 
   * @param parent
   ...
   * will search its own repositories first, and delegate to the parent only if
  ...
  /**
   * The set of optional packages (formerly standard extensions) that are
   * required in the repositories associated with this class loader. Each object
   * in this list is of type <code>org.apache.catalina.loader.Extension</code>.
   */
  protected ArrayList required = new ArrayList();

  /**
   * A list of read File and Jndi Permission's required if this loader is for a
  ...
  /**
   * Return a list of "optional packages" (formerly "standard extensions") that
   * have been declared to be available in the repositories associated with this
   * class loader, plus any parent class loader implemented with the same class.
   */
  ...
  /**
   * Return a String array of the current repositories for this class loader. If
   * there are no repositories, a zero-length array is returned.
   */
  ...
  /**
   * Return a list of "optional packages" (formerly "standard extensions") that
   * have been declared to be required in the repositories associated with this
   * class loader, plus any parent class loader implemented with the same class.
   */
   ...
   * <ul>
   * <li>If the <code>delegate</code> property is set to <code>true</code>, call
   * the <code>getResource()</code> method of the parent class loader, if any.</li>
   * <li>Call <code>findResource()</code> to find this resource in our locally
   * defined repositories.</li>
   * <li>Call the <code>getResource()</code> method of the parent class loader,
   * if any.</li>
   * </ul>
   * 
   * @param name
  ...
  /**
   * Find the resource with the given name, and return an input stream that can
   * be used for reading it. The search order is as described for
   * <code>getResource()</code>, after checking to see if the resource data has
   * been previously cached. If the resource cannot be found, return
   * <code>null</code>.
   * 
   * @param name
  ...
  /**
   * Load the class with the specified name. This method searches for classes in
   * the same manner as <code>loadClass(String, boolean)</code> with
   ...
   * returned.</li>
   * <li>If the <code>delegate</code> property is set to <code>true</code>, call
   * the <code>loadClass()</code> method of the parent class loader, if any.</li>
   * <li>Call <code>findClass()</code> to find this class in our locally defined
   * repositories.</li>
   * <li>Call the <code>loadClass()</code> method of our parent class loader, if
   * any.</li>
   * </ul>
   * If the class was found using the above steps, and the <code>resolve</code>
   * flag is <code>true</code>, this method will then call
   * <code>resolveClass(Class)</code> on the resulting Class object.
   * 
   * @param name
   *          Name of the class to be loaded
   * @param resolve
   ...
   * FilePermissions for the base directory (if unpacked), the context URL, and
   * jar file resources.
   * 
   * @param CodeSource
  ...
  /**
   * Finds the resource with the given name if it has previously been loaded and
   * cached by this class loader, and return an input stream to the resource
   * data. If this resource has not been cached, return <code>null</code>.
   * 
   * @param name
