/**
  * $Header: /home/master/nWave-DM-Common/test/com/npower/cp/template/TestMMSTemplate.java,v 1.2 2007/10/09 02:09:31 LAH Exp $
  * $Revision: 1.2 $
 ...
 */
public class TestMMSTemplate extends BaseTestCase {
   ...
   * @return
   */
  private OMAClientProvSettings getMMSSettings() {
    ...
    ApplicationElement application = new ApplicationElement(AppID.W4_MMS_User_Agent);
  ...
  public void testMergeOMACP() throws Exception {
    ...
    ClientProvTemplate template = inventory.findTemplate(null, null, ProfileCategory.MMS_CATEGORY_NAME);
    assertNotNull(template);
    
    OMAClientProvSettings settings = getMMSSettings();
  ...
  public void testMergeNokia() throws Exception {
    ...
    ClientProvTemplate template = inventory.findTemplate("nokia", "6681", ProfileCategory.MMS_CATEGORY_NAME);
    assertNotNull(template);
  ...
  /**
   * 测试SonyEricsson W800的MMS模板的合并结果.
   * @throws Exception
   */
  public void testMergeSonyEricssonW800() throws Exception {
    ...
    ClientProvTemplate template = inventory.findTemplate("SonyEricsson", "W800", ProfileCategory.MMS_CATEGORY_NAME);
    assertNotNull(template);
  ...
  /**
   * 测试SonyEricsson W810的MMS模板的合并结果.
   * @throws Exception
   */
  public void testMergeSonyEricsson810() throws Exception {
    ...
    ClientProvTemplate template = inventory.findTemplate("SonyEricsson", "W810", ProfileCategory.MMS_CATEGORY_NAME);
    assertNotNull(template);
