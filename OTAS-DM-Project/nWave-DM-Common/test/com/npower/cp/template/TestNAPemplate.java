/**
  * $Header: /home/master/nWave-DM-Common/test/com/npower/cp/template/TestNAPemplate.java,v 1.2 2007/10/09 02:09:31 LAH Exp $
  * $Revision: 1.2 $
 ...
 */
public class TestNAPemplate extends BaseTestCase {
   ...
   * @return
   */
  private OMAClientProvSettings getNAPSettings() {
  ...
  public void testMergeOMACP() throws Exception {
    ...
    ClientProvTemplate template = inventory.findTemplate(null, null, ProfileCategory.NAP_CATEGORY_NAME);
    assertNotNull(template);
    
    OMAClientProvSettings settings = getNAPSettings();
  ...
  public void testMergeNokia() throws Exception {
    ...
    ClientProvTemplate template = inventory.findTemplate("nokia", "6681", ProfileCategory.NAP_CATEGORY_NAME);
    assertNotNull(template);
  ...
  /**
   * 测试SonyEricsson W800的NAP模板的合并结果.
   * @throws Exception
   */
  public void testMergeSonyEricssonW800() throws Exception {
    ...
    ClientProvTemplate template = inventory.findTemplate("SonyEricsson", "W800", ProfileCategory.NAP_CATEGORY_NAME);
    assertNotNull(template);
  ...
  /**
   * 测试SonyEricsson W810的NAP模板的合并结果.
   * @throws Exception
   */
  public void testMergeSonyEricsson810() throws Exception {
    ...
    ClientProvTemplate template = inventory.findTemplate("SonyEricsson", "W810", ProfileCategory.NAP_CATEGORY_NAME);
    assertNotNull(template);
