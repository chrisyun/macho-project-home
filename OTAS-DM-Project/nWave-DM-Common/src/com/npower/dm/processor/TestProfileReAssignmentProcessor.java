/**
  * $Header: /home/master/nWave-DM-Common/src/com/npower/dm/processor/TestProfileReAssignmentProcessor.java,v 1.19 2008/08/04 07:13:34 zhao Exp $
  * $Revision: 1.19 $
...
/**
 * @author Zhao DongLu
 * @version $Revision: 1.19 $ $Date: 2008/08/04 07:13:34 $
 */
public class TestProfileReAssignmentProcessor extends TestCase {
  ...
  private void setUpProfileConfigs(String carrierExternalID) throws Exception {
    ...
    try {
        ...
        }
        {
          ...
          String profileName = templateName;
          String typeOfProfile = "TEST.Proxy";
          ProfileConfig profile = this.createProfileConfig(factory, carrierExternalID, templateName, profileName, typeOfProfile);
        ...
        }
        {
          ...
          String profileName = templateName;
          String typeOfProfile = "TEST.Email";
          ProfileConfig profile = this.createProfileConfig(factory, carrierExternalID, templateName, profileName, typeOfProfile);
  ...
  private void emulate(DMClientEmulator emulator, long jobID) throws IOException, Exception {
    ...
    BaseProcessor processor = new ProfileReAssignmentProcessor();
  ...
  public void testProcessor4NAP_No_Exists() throws Exception {
    ...
    try {
        ...
        assertEquals("GSM-GPRS", emulator.getValue("./AP/OTAS100/NAPDef/OTAS1/Bearer/OTAS2/BearerL"));
        assertEquals(ATTRIBUTE_DEFAULT_VALUE, emulator.getValue("./AP/OTAS100/NAPDef/OTAS1/Bearer/OTAS2/Direction"));
        // 无法通过, DDF定义中, DNSAddr为node类型
        //assertEquals(ATTRIBUTE_DEFAULT_VALUE, emulator.getValue("./AP/OTAS100/NAPDef/OTAS1/DNSAddr"));
        assertEquals(ATTRIBUTE_DEFAULT_VALUE, emulator.getValue("./AP/OTAS100/NAPDef/OTAS1/NAPAddr"));
        assertEquals(ATTRIBUTE_DEFAULT_VALUE, emulator.getValue("./AP/OTAS100/NAPDef/OTAS1/NAPAddrTy"));
        assertEquals(null, emulator.getValue("./AP/OTAS100/NAPDef/OTAS1/NAPAuthInf"));
        assertEquals(ATTRIBUTE_DEFAULT_VALUE, emulator.getValue("./AP/OTAS100/NAPDef/OTAS1/NAPAuthInf/OTAS3/AuthName"));
        assertEquals(ATTRIBUTE_DEFAULT_VALUE, emulator.getValue("./AP/OTAS100/NAPDef/OTAS1/NAPAuthInf/OTAS3/AuthSecr"));
        assertEquals(ATTRIBUTE_DEFAULT_VALUE, emulator.getValue("./AP/OTAS100/NAPDef/OTAS1/Name"));
        assertEquals(ATTRIBUTE_DEFAULT_VALUE, emulator.getValue("./AP/OTAS100/NAPDef/OTAS1/Bearer/OTAS2/Direction"));
  ...
  */
  ...
  public void testProcessor4EMAIL_No_Exists() throws Exception {
    ...
    try {
        ...
        assertEquals("OTAS Email", emulator.getValue("./Email/OTAS200/Name"));
        assertEquals("zhaodonglu", emulator.getValue("./Email/OTAS200/UID"));
        assertEquals("POP", emulator.getValue("./Email/OTAS200/Mpro"));
        assertEquals("smtp.otas.cn", emulator.getValue("./Email/OTAS200/Msnd"));
        assertEquals("pop.otas.cn", emulator.getValue("./Email/OTAS200/Mrcv"));
        assertEquals("Zhao DongLu", emulator.getValue("./Email/OTAS200/UName"));
        assertEquals("zhaodonglu@otas.cn", emulator.getValue("./Email/OTAS200/UAddr"));
        assertEquals("zhaodonglu", emulator.getValue("./Email/OTAS200/PW"));
  ...
  public static void main(String[] args) {
    junit.textui.TestRunner.run(TestProfileReAssignmentProcessor.class);
  }
