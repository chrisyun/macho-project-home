/**
 * $Header: /home/master/nWave-DM-Common/src/com/npower/dm/core/selector/DisjunctionModelSelector.java,v 1.3 2008/09/05 04:32:35 zhao Exp $
 * $Revision: 1.3 $
 ...
 */
public class DisjunctionModelSelector extends AbstractModelSelector implements ModelSelector {
   ...
   * 
   */
  public DisjunctionModelSelector() {
    super();
  }
   ...
   * @return
   */
  public DisjunctionModelSelector add(ModelSelector selector) {
  ...
  public Set<Model> getModels() throws DMException {
    ...
    for (ModelSelector selector: this.selectors) {
        result.addAll(selector.getModels());
    }
    return result;
  }
