/**
 * $Header: /home/master/nWave-DM-Common/src/com/npower/dm/msm/S60V3DeactiveProcessor.java,v 1.1 2008/04/08 11:32:15 zhao Exp $
 * $Revision: 1.1 $
 ...
 */
public class S60V3DeactiveProcessor extends S60V3OperationProcessor {

  /**
   * 
   */
  public S60V3DeactiveProcessor() {
    super();
  }
  ...
  public TreeNode getExecuteTagetNode(Software software) {
    ...
    TreeNode treeNode = new TreeNode(baseNodePath  + "/Operations/Deactivate");
