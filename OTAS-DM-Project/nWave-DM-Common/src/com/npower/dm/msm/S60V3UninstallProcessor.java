/**
 * $Header: /home/master/nWave-DM-Common/src/com/npower/dm/msm/S60V3UninstallProcessor.java,v 1.2 2008/04/08 11:32:15 zhao Exp $
 * $Revision: 1.2 $
...
/**
 * @author Zhao DongLu
 * @version $Revision: 1.2 $ $Date: 2008/04/08 11:32:15 $
 */
public class S60V3UninstallProcessor extends S60V3OperationProcessor {

  /**
   * 
   */
  public S60V3UninstallProcessor() {
    super();
  }
  ...
  public TreeNode getExecuteTagetNode(Software software) {
    ...
    TreeNode treeNode = new TreeNode(baseNodePath  + "/Operations/Remove");
