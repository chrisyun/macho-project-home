/**
  * $Header: /home/master/nWave-DM-Common/src/com/npower/dm/test/SetupNAPJob4Nokia6620.java,v 1.7 2008/06/16 10:11:15 zhao Exp $
  * $Revision: 1.7 $
 ...
 */
public class SetupNAPJob4Nokia6620 extends TestCase {
  /**
   * 
   */
  ...
  private void setUpProfileConfigs(String carrierExternalID) throws Exception {
    ...
    try {
        factory.beginTransaction();
        {
          ...
          profileBean.setAttributeValue(profile, "TEST Display Name",            "OTAS AP");
          profileBean.setAttributeValue(profile, "TEST Bearer Direction",        "Outgoing");
          profileBean.setAttributeValue(profile, "TEST NAP Address",             "127.0.0.1");
          profileBean.setAttributeValue(profile, "TEST NAP Address Type",        "APN");
          profileBean.setAttributeValue(profile, "TEST DNS Address",             "127.0.0.1");
          profileBean.setAttributeValue(profile, "TEST Authentication Username", "");
          profileBean.setAttributeValue(profile, "TEST Authentication Password", "");
        }
        {
  ...
  public void testProcessor4NAP() throws Exception {
    ...
    try {
        factory.beginTransaction();
        ProfileAssignment assignment = this.setupProfileAssignment(factory, PROFILE_TEMPLATE_NAME_4_NAP, Device_External_ID, ProfileCategory.NAP_CATEGORY_NAME);
        ProvisionJobBean jobBean = factory.createProvisionJobBean();
