/**
 * $Header: /home/master/nWave-DM-Common/src/com/npower/dm/hibernate/entity/AbstractReplaceCommandItem.java,v 1.2 2006/04/25 16:31:09 zhao Exp $
 * $Revision: 1.2 $
 ...
 */
public abstract class AbstractReplaceCommandItem implements java.io.Serializable {

  // Fields

  private ReplaceCommandItemID id;
  ...
  /** default constructor */
  public AbstractReplaceCommandItem() {
  }

  /** minimal constructor */
  public AbstractReplaceCommandItem(DMCommand nwDmDmCmd) {
    this.nwDmDmCmd = nwDmDmCmd;
  }

  /** full constructor */
  public AbstractReplaceCommandItem(DMCommand nwDmDmCmd, String target, String MFormat, String MType,
      String itemDataKind, String updateId, Clob rawData, Blob binaryData) {
    this.nwDmDmCmd = nwDmDmCmd;
    this.target = target;
  ...
  public ReplaceCommandItemID getId() {
    return this.id;
  }

  public void setId(ReplaceCommandItemID id) {
    this.id = id;
  }
