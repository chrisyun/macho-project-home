/**
  * $Header: /home/master/nWave-DM-Common/src/com/npower/dm/audit/action/ManufacturerAction.java,v 1.1 2007/02/07 08:42:09 zhao Exp $
  * $Revision: 1.1 $
...
public enum ManufacturerAction {
   ...
   *        Value of action
   */
  private ManufacturerAction(String value) {
    this.value = value;
  }
