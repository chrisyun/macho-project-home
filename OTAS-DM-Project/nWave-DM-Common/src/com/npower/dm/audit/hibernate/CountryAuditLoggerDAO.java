/**
  * $Header: /home/master/nWave-DM-Common/src/com/npower/dm/audit/hibernate/CountryAuditLoggerDAO.java,v 1.1 2007/02/08 07:11:59 zhao Exp $
  * $Revision: 1.1 $
 ...
 */
public class CountryAuditLoggerDAO extends BaseAuditLogger implements CountryAuditLogger {

  /**
   * Default constructor.
   */
  public CountryAuditLoggerDAO() {
    super();
  }
  
  /* (non-Javadoc)
   * @see com.npower.dm.audit.CountryAuditLogger#log(com.npower.dm.audit.action.CountryAction, java.lang.String, java.lang.String, long, java.lang.String, java.lang.String)
   */
  public long log(CountryAction action, String username, String ipAddress, long countryID, String countryExtID, String description) throws AuditException {
    if (!this.isEnable()) {
       return 0;
    }
    if (action == null) {
    ...
    if (countryID == 0) {
       throw new AuditException("Must specified countryID.");
    }
    ...
    target.setCountryId("" + countryID);
    target.setCountryExternalId(countryExtID);
