/**
  * $Header: /home/master/nWave-DM-Common/src/com/npower/dm/audit/hibernate/UpdateAuditLoggerDAO.java,v 1.1 2007/02/08 10:49:06 zhao Exp $
  * $Revision: 1.1 $
 ...
 */
public class UpdateAuditLoggerDAO extends BaseAuditLogger implements UpdateAuditLogger {

  /**
   * Default constructor.
   */
  public UpdateAuditLoggerDAO() {
    super();
  }
  
  /* (non-Javadoc)
   * @see com.npower.dm.audit.UpdateAuditLogger#log(com.npower.dm.audit.action.UpdateAction, java.lang.String, java.lang.String, long, java.lang.String, long, java.lang.String)
   */
  public long log(UpdateAction action, String username, String ipAddress, long modelID, String modeName, long updateID, String description) throws AuditException {
    if (!this.isEnable()) {
       return 0;
    }
    if (action == null) {
    ...
    if (updateID == 0) {
       throw new AuditException("Must specified updateID.");
    }
