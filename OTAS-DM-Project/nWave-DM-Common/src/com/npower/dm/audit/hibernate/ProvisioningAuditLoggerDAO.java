/**
  * $Header: /home/master/nWave-DM-Common/src/com/npower/dm/audit/hibernate/ProvisioningAuditLoggerDAO.java,v 1.1 2007/02/08 10:49:06 zhao Exp $
  * $Revision: 1.1 $
 ...
 */
public class ProvisioningAuditLoggerDAO extends BaseAuditLogger implements ProvisioningAuditLogger {

  /**
   * Default constructor.
   */
  public ProvisioningAuditLoggerDAO() {
    super();
  }
  
  /* (non-Javadoc)
   * @see com.npower.dm.audit.ProvisioningAuditLogger#log(com.npower.dm.audit.action.ProvisioningAction, java.lang.String, java.lang.String, long, java.lang.String)
   */
  public long log(ProvisioningAction action, String username, String ipAddress, long jobID, String description) throws AuditException {
    if (!this.isEnable()) {
       return 0;
    }
    if (action == null) {
    ...
    if (jobID == 0) {
       throw new AuditException("Must specified jobID.");
    }
